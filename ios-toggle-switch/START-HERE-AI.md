...
iOS Toggle Switch is a production-ready GSAP UI component from GSAP Vault. This file is designed for Cursor, Claude Code, ChatGPT, GitHub Copilot, Windsurf, and other coding assistants.
...
```text
Integrate the supplied iOS Toggle Switch UI component into my project.
...
4. Reuse the project's existing GSAP installation where possible. Register only the plugins this product needs: Draggable.
