...
Skeleton Loader is a production-ready GSAP UI component from GSAP Vault. This file is designed for Cursor, Claude Code, ChatGPT, GitHub Copilot, Windsurf, and other coding assistants.

## Product context

- Product: Skeleton Loader
- Type: UI component
- Description: A skeleton loader: shimmering placeholders crossfade into real content with a stagger, and each card's height eases to what it loaded.
- GSAP plugins: GSAP core only
- Techniques: load-sequence, stagger, crossfade, progressive-enhancement
...
```text
Integrate the supplied Skeleton Loader UI component into my project.
