...
Progress Stepper is a production-ready GSAP UI component from GSAP Vault. This file is designed for Cursor, Claude Code, ChatGPT, GitHub Copilot, Windsurf, and other coding assistants.

## Product context

- Product: Progress Stepper
- Type: UI component
- Description: A progress stepper for checkouts and onboarding: the track fills to the active step and completed steps flip into a drawn checkmark.
- GSAP plugins: GSAP core only
- Techniques: progress-bar, timeline-control, svg-stroke, form-animation
...
```text
Integrate the supplied Progress Stepper UI component into my project.
