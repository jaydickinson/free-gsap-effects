...
Tailwind Component Remixer is a production-ready GSAP animation effect from GSAP Vault. This file is designed for Cursor, Claude Code, ChatGPT, GitHub Copilot, Windsurf, and other coding assistants.

## Product context

- Product: Tailwind Component Remixer
- Type: animation effect
- Description: Generate fresh Tailwind component recipes with procedural SVG artwork, coordinated colour palettes and animated GSAP layout transitions.
- GSAP plugins: Flip
- Techniques: tailwind-css, class-mutation, flip-layout, random-class-recipes, clipboard, click-toggle, keyboard-navigation, procedural-svg
...
```text
Integrate the supplied Tailwind Component Remixer animation effect into my project.
...
4. Reuse the project's existing GSAP installation where possible. Register only the plugins this product needs: Flip.
