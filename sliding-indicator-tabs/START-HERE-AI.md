...
Animated Tabs is a production-ready GSAP UI component from GSAP Vault. This file is designed for Cursor, Claude Code, ChatGPT, GitHub Copilot, Windsurf, and other coding assistants.

## Product context

- Product: Animated Tabs
- Type: UI component
- Description: Animated tabs: the indicator slides and stretches between tabs, panels change directionally and the container eases between heights.
...
```text
Integrate the supplied Animated Tabs UI component into my project.
