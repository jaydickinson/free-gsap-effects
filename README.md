...
| [Image Clip Reveal](./image-clip-reveal) | A cinematic image reveal where a directional polygon aperture opens as the photograph settles from a restrained Ken Burns scale and its caption lands. | [Demo](https://gsapvault.com/effects/image-clip-reveal) |
