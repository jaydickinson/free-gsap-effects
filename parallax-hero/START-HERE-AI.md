...
Parallax Hero is a production-ready GSAP animation effect from GSAP Vault. This file is designed for Cursor, Claude Code, ChatGPT, GitHub Copilot, Windsurf, and other coding assistants.
...
```text
Integrate the supplied Parallax Hero animation effect into my project.
